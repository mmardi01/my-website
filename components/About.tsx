...
export default function About() {
  ...
  className='text-center scroll-mt-[8rem] mb-28 sm:mb-40 max-w-[45rem] leading-8'>
    ...
    <p className='mb-3'>
      ...
      some of which have spanned several months.
      These experiences have fostered my deep passion for tackling complex problems and honing my skills as a problem solver. 
